  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8">Transaction Logs</h1>
        ...
        {summary && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <p className="text-gray-600 text-sm">Total Matured</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-2xl font-bold">{summary.active_investments || 0}</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <p className="text-gray-600 text-sm">Cancelled</p>
              <p className="text-2xl font-bold">{summary.cancelled_investments || 0}</p>
            </div>
          </div>
        )}
